@extends('layouts.app_auth', ['title' => 'Daftar'])
@section('content')
    <main>
                ...
                <div class="flex flex-wrap items-center">
                    ...
                    <div class="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
                        <div class="w-full p-4 sm:p-12.5 xl:p-17.5">
                            <span class="mb-1.5 block font-medium">Mulai laporkan dengan mudah dan aman</span>
                            ...
                            <form>
                                <div class="mb-4">
                                    ...
                                    <div class="relative">
                                        <input type="text" placeholder="Masukan nama lengkap anda" autocomplete="off"
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="relative">
                                        <input type="email" placeholder="Masukan alamat email anda" autocomplete="off"
                                            class="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="relative">
                                        <input type="password" placeholder="6+ Karakter, 1 Huruf Besar"
                                            class="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                                ...
                                <div class="mb-6">
                                    <label class="mb-2.5 block font-medium text-black dark:text-white">Konfirmasi Kata Sandi</label>
                                    <div class="relative">
                                        <input type="password" placeholder="Masukan ulang kata sandi anda"
                                            class="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                                ...
                                <div class="mb-5">
                                    <input type="submit" value="Buat Akun"
                                        class="w-full cursor-pointer rounded-lg border border-primary bg-indigo-600 p-4 font-medium text-white transition hover:bg-opacity-90" />
                                </div>
